-- TEMPORARY: Force specific memory ID to debug extra_data
...
BEGIN
    ...
    WITH all_memories_raw AS (
        ...
        WHERE m.couple_id = p_couple_id
            ...
            AND (p_exclude_date IS NULL OR DATE(m.created_at) != p_exclude_date)
            -- FILTER FOR SPECIFIC TESTY MEMORY
            AND m.id = '071478ab-5567-4c59-a2bc-2bdfb498a3fd'
        
        UNION ALL
        -- ... (other unions omitted for brevity, logic remains same)
