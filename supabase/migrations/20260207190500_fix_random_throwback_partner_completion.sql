-- Migration: Fix challenge completion logic in get_random_throwback
-- 1. Adds 'partner_completed' flag by checking if partner has also uploaded a memory for this challenge
-- 2. Keeps robust answer fetching and content visibility from previous fixes
