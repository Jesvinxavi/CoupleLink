-- Migration: Fix OFFSET variable error in get_random_throwback
-- 1. Replaces OFFSET calculation with ROW_NUMBER() window function
-- 2. Preserves all previous fixes (partner_completion, content visibility, removed invalid category)
