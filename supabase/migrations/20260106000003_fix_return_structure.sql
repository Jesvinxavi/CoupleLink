-- Fix get_active_challenge to return 'content' object as expected by frontend
-- The previous update flattened the structure which broke the frontend data mapping
...
BEGIN
    ...
    SELECT jsonb_build_object(
        ...
        'content', content -- <--- RESTORED: Pass the full content object
    )
