-- Migration: Fix invalid column reference in get_random_throwback
-- 1. Removes cp.category from completed_positions query block as column does not exist
-- 2. Preserves partner_completion logic and content visibility fixes
