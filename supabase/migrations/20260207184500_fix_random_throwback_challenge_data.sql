-- Migration: Fix get_random_throwback challenge answers join and metadata
-- 1. Fixes missing answers by adding a fallback join on Title if challenge_id is NULL
-- 2. Includes challenge_type and is_competition from metadata
