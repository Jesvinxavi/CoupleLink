...
export function NeverHaveIEverGame({ session }: NeverHaveIEverGameProps) {
    ...
    const currentQuestion = useMemo(() => {
        ...
        return neverHaveIEverQuestions.find(q => q.id === currentQuestionId);
    }, [currentQuestionId]);
        ...
        return (
            <div className="text-center py-2">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-6 my-6">
                    <p className="text-4xl font-bold text-blue-500 mb-2">{matchPercentage}%</p>
                    <p className="text-gray-600 dark:text-gray-400">Similar Experiences</p>
    ...
    return (
        <div className="max-w-lg mx-auto">
            ...
            <motion.div
                ...
                className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-6 mb-6"
            >
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
                <motion.button
                    whileHover={myAnswer === undefined ? { scale: 1.02 } : {}}
                    whileTap={myAnswer === undefined ? { scale: 0.98 } : {}}
                ...
                >
                    ...
                    <span className={`font-bold text-lg ${myAnswer === true ? 'text-white' : 'text-gray-900 dark:text-white'
                        }`}>
                        I Have
                    </span>
                    {myAnswer === true && (
                        <div className="text-sm mt-1 text-white/80">Your answer</div>
                    )}
                </motion.button>
                ...
                >
                    ...
                    <span className={`font-bold text-lg ${myAnswer === false ? 'text-white' : 'text-gray-900 dark:text-white'
                        }`}>
                        I Haven't
                    </span>
                    {myAnswer === false && (
                ...
                {myAnswer !== undefined && !bothAnswered && (
                    ...
                    >
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            Waiting for {partner?.first_name || 'partner'} to answer...
                        </p>
                    </motion.div>
                )}
                {bothAnswered && (
