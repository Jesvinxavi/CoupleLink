        ...
        <>
            <div className="rounded-2xl bg-white p-4 shadow-sm h-full flex gap-3">
                ...
                <button
                    ...
                    className="flex-[2] bg-rose-50 hover:bg-rose-100 rounded-xl p-4 flex flex-col justify-between text-left transition-colors group relative overflow-hidden"
                >
                    ...
                    <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-rose-200/30 rounded-full blur-2xl group-hover:bg-rose-200/50 transition-colors" />
                </button>

                {/* Post Note Button (1/3 width) */}
                <button
                    onClick={() => setIsNoteModalOpen(true)}
                    className="flex-1 bg-yellow-50 hover:bg-yellow-100 rounded-xl p-4 flex flex-col justify-between text-left transition-colors group relative overflow-hidden"
                >
                    <div className="relative z-10">
                    ...
                    {/* Decorative background element */}
                    <div className="absolute -top-4 -right-4 w-20 h-20 bg-yellow-200/30 rounded-full blur-xl group-hover:bg-yellow-200/50 transition-colors" />
                </button>
            </div>
