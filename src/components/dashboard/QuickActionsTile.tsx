    ...
    return (
        <>
            <div className="rounded-2xl bg-white p-4 shadow-sm h-full flex gap-3">
                {/* Journal Button (2/3 width) */}
                <button
                    onClick={handleJournalClick}
                    className="flex-[2] bg-rose-50 md:hover:bg-rose-100 active:bg-rose-100 rounded-xl p-4 flex flex-col justify-between text-left transition-colors group relative overflow-hidden"
                >
                    <div className="relative z-10">
                        <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center mb-3 shadow-sm text-rose-500 md:group-hover:scale-110 group-active:scale-110 transition-transform">
                        ...
                        <p className="text-xs text-gray-500 mt-1 md:group-hover:text-rose-600/80 group-active:text-rose-600/80 transition-colors line-clamp-2">
                ...
                >
                    <div className="relative z-10">
                        <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center mb-3 shadow-sm text-yellow-600 md:group-hover:scale-110 group-active:scale-110 transition-transform">
                        ...
                        <p className="text-xs text-gray-500 mt-1 md:group-hover:text-yellow-700/80 group-active:text-yellow-700/80 transition-colors">
                            Leave a sticky
                        </p>
                    </div>
